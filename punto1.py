...
def eliminar_duplicados(datos_duplicados):
    ...
    lista_limpia = list(set(int(datos_duplicados))) # Los conjuntos no pueden tener datos duplicados, creo uno y le paso la lista duplicada, luego lo convierto a lista con list() y la retorno
